...
IMPL_MODEL(tunnel_router_event, TUNNEL_ROUTER_EVENT)
IMPL_MODEL(tunnel_posture_status_event, TUNNEL_POSTURE_STATUS_EVENT)
IMPL_MODEL(tunnel_health_status_event, TUNNEL_HEALTH_STATUS_EVENT)
