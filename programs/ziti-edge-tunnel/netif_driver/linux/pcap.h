...
#ifndef ZITI_TUNNEL_SDK_C_LINUX_PCAP_H
#define ZITI_TUNNEL_SDK_C_LINUX_PCAP_H

#include <ziti/netif_driver.h>

/**
 * Open a physical network adapter via libpcap as an L2 netif driver.
 *
 * Opens the adapter named by ifname (Linux interface name, e.g. "eth0"),
 ...
 *
 * Requires libpcap installed and CAP_NET_RAW capability (or root).
 *
 * @param loop      libuv event loop
 * @param ifname    Linux network interface name (e.g. "eth0", "enp0s3")
...
#endif /* ZITI_TUNNEL_SDK_C_LINUX_PCAP_H */
