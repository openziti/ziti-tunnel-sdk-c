...
if(CPACK_GENERATOR MATCHES "RPM")
    if(CPACK_DISABLE_LIBPCAP_FEATURE)
        set(CPACK_RPM_BUILD_REQUIRES_PCAP "")
        set(CPACK_RPM_PACKAGE_REQUIRES_PCAP "")
    else()
        set(CPACK_RPM_BUILD_REQUIRES_PCAP ", libpcap-devel")
        set(CPACK_RPM_PACKAGE_REQUIRES_PCAP ", libpcap")
    endif()
    set(CPACK_RPM_BUILD_REQUIRES "cmake >= ${CMAKE_MINIMUM_REQUIRED_VERSION}, systemd-devel, gawk, gcc-c++ >= 4.9, json-c-devel ${CPACK_RPM_BUILD_REQUIRES_PCAP}, protobuf-c-devel, python3, openssl-devel, zlib-devel")
    ...
    set(CPACK_RPM_PACKAGE_REQUIRES "iproute, gawk, systemd, libatomic ${CPACK_RPM_PACKAGE_REQUIRES_PCAP}, json-c, protobuf-c, openssl-libs, zlib, polkit")
...
if(CPACK_GENERATOR MATCHES "DEB")
    ...
    if(CPACK_DISABLE_LIBPCAP_FEATURE)
        set(CPACK_DEBIAN_PACKAGE_DEPENDS_PCAP "")
    else()
        set(CPACK_DEBIAN_PACKAGE_DEPENDS_PCAP ", libpcap0.8 | libpcap0.8t64")
    endif()
    set(CPACK_DEBIAN_PACKAGE_DEPENDS "debconf, iproute2, sed, systemd, libatomic1, libjson-c3 | libjson-c4 | libjson-c5 ${CPACK_DEBIAN_PACKAGE_DEPENDS_PCAP}, libprotobuf-c1, libssl3 | libssl1.1 | libssl1.0.0, login, passwd, policykit-1 | polkitd, zlib1g")
